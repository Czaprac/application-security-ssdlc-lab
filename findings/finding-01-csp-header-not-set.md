...
ASVS v5.0.0-3.4.3 verifies that HTTP responses include a Content-Security-Policy response header field that defines directives to ensure the browser only loads and executes trusted content or resources.
